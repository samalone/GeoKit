...
/// Layouts are my attempt to create a taxonomy of sailboat racing courses.
...
///
/// Most of Proper Course does not use Layouts directly. Instead Layouts
